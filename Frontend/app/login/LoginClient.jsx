      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-2xl shadow-xl border border-border">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          <div className="space-y-4 rounded-md shadow-sm">
            <div>
              <label htmlFor="email-address" className="text-sm font-medium text-text-dark">Email address</label>
              <Input
                id="email-address"
                name="email"
                type="email"
                ...
                defaultValue="demo@resumeai.com"
              />
            </div>
            <div>
              <label htmlFor="password" className="text-sm font-medium text-text-dark">Password</label>
              <Input
                id="password"
                name="password"
                type="password"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Button type="button" variant="outline" className="w-full h-11 text-base font-medium text-gray-700 bg-white hover:bg-gray-50">
