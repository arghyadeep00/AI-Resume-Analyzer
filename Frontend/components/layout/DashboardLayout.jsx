    ...
    <div className="flex h-screen bg-secondary overflow-hidden">
      ...
      >
        ...
        <div className="p-4 space-y-1 overflow-y-auto h-[calc(100vh-4rem)] pb-24">
          <div className="text-xs font-semibold text-text-muted mb-4 uppercase tracking-wider px-2">
            Menu
          </div>
          {navItems.map((item) => {
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-border flex items-center justify-between px-4 sm:px-6 z-10 shrink-0">
          <div className="flex items-center gap-4">
            <button
              className="md:hidden p-2 -ml-2 text-text-dark"
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden sm:block text-right">
                <div className="text-sm font-medium text-text-dark leading-none">
                  {session?.user?.name}
                </div>
